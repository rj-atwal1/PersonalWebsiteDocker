...
DB_PATH = _path_from_env("PROJECTS_DB_PATH", Path(__file__).with_name("projects.db"))
STATIC_IMAGES_DIR = _path_from_env("STATIC_IMAGES_DIR", Path(__file__).with_name("static") / "images")
